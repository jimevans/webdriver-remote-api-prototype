...
namespace OpenQA.Selenium.IE
{
    ...
    public class InternetExplorerOptions : DriverOptions
    {
        ...
        private const string HasNativeEventsCapability = "hasNativeEvents";
        ...
        {
            DesiredCapabilities capabilities = base.ToCapabilities() as DesiredCapabilities;
        ...
        private Dictionary<string, object> BuildInternetExplorerOptionsDictionary()
        {
            ...
            internetExplorerOptionsDictionary[HasNativeEventsCapability] = this.enableNativeEvents;
